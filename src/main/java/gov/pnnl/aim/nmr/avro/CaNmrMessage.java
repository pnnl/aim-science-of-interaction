...
public class CaNmrMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CaNmrMessage\",\"namespace\":\"gov.pnnl.aim.nmr.avro\",\"fields\":[{\"name\":\"version\",\"type\":\"int\"},{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"fileName\",\"type\":\"string\"},{\"name\":\"rowNumber\",\"type\":\"int\"},{\"name\":\"sampleID\",\"type\":\"string\"},{\"name\":\"qualityStatus\",\"type\":\"int\"},{\"name\":\"spectrum\",\"type\":{\"type\":\"array\",\"items\":\"double\"}}]}");
   ...
   */
  public CaNmrMessage(java.lang.Integer version, java.lang.Long timestamp, java.lang.CharSequence fileName, java.lang.Integer rowNumber, java.lang.CharSequence sampleID, java.lang.Integer qualityStatus, java.util.List<java.lang.Double> spectrum) {
  ...
  /** Creates a new CaNmrMessage RecordBuilder */
  public static gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder newBuilder() {
    return new gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder();
  }
  
  /** Creates a new CaNmrMessage RecordBuilder by copying an existing Builder */
  public static gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder newBuilder(gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder other) {
    return new gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder(other);
  }
  
  /** Creates a new CaNmrMessage RecordBuilder by copying an existing CaNmrMessage instance */
  public static gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder newBuilder(gov.pnnl.aim.nmr.avro.CaNmrMessage other) {
    return new gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder(other);
  }
  
  /**
   * RecordBuilder for CaNmrMessage instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CaNmrMessage>
    implements org.apache.avro.data.RecordBuilder<CaNmrMessage> {
    ...
    private Builder() {
      super(gov.pnnl.aim.nmr.avro.CaNmrMessage.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing CaNmrMessage instance */
    private Builder(gov.pnnl.aim.nmr.avro.CaNmrMessage other) {
            super(gov.pnnl.aim.nmr.avro.CaNmrMessage.SCHEMA$);
      if (isValidValue(fields()[0], other.version)) {
        this.version = data().deepCopy(fields()[0].schema(), other.version);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'version' field */
    public gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder setVersion(int value) {
    ...
    public gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder clearVersion() {
    ...
    /** Sets the value of the 'timestamp' field */
    public gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder setTimestamp(long value) {
    ...
    public gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'fileName' field */
    public gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder setFileName(java.lang.CharSequence value) {
    ...
    public gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder clearFileName() {
      fileName = null;
    ...
    /** Sets the value of the 'rowNumber' field */
    public gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder setRowNumber(int value) {
    ...
    public gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder clearRowNumber() {
    ...
    /** Sets the value of the 'sampleID' field */
    public gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder setSampleID(java.lang.CharSequence value) {
    ...
    public gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder clearSampleID() {
      sampleID = null;
    ...
    /** Sets the value of the 'qualityStatus' field */
    public gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder setQualityStatus(int value) {
    ...
    public gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder clearQualityStatus() {
    ...
    /** Sets the value of the 'spectrum' field */
    public gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder setSpectrum(java.util.List<java.lang.Double> value) {
    ...
    public gov.pnnl.aim.nmr.avro.CaNmrMessage.Builder clearSpectrum() {
      spectrum = null;
    ...
    @Override
    public CaNmrMessage build() {
      try {
        CaNmrMessage record = new CaNmrMessage();

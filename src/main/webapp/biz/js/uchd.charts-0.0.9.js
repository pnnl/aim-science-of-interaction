        ...
        generator = {
            ...
            initialize: function()
            {
                ...
                flow = d3.svg.area()
                    ...
                    .y(function(d)
                    {
                        return (d.y > chart.threshold() ? (chart.y()(d.i) - offset) : chart.y()(d.i));
                    })
                    .y1(function(d)
                    {
                        return (d.y > chart.threshold() ? (chart.y()(d.i) + offset) : chart.y()(d.i));
                    ...
                    .interpolate("cardinal"
                        ...
                        //                                if (p0)
                        //                                {
                        //                                    midX = Math.round((p0[0] + p1[0]) / 2);
                        //                                    halfHorz = Math.round(Math.abs(p1[0] - p0[0]) / 4);
                        //
                        //                                    if (move)
                        //                                    {
                        //                                        str = [" h", halfHorz,
                        //                                                " C", midX, ",", p0[1], " ", midX, ",", p1[1], " ", p1[0] - halfHorz, ",", p1[1],
                        //                                                " h", halfHorz, " "
                        //                                            ]
                        //                                            .join("");
                        //                                        mirror.push(["h", -halfHorz, "C", midX, ",", p1[1], " ", midX, ",", p0[1], " ", p0[0] + halfHorz, ",",
                        //                                                p0[1], " ",
                        //                                                " h", -halfHorz
                        //                                            ]
                        //                                            .join(""));
                        ...
                        //                                    {
                        //                                        offset = 6;
                        //                                        str = [" v", -offset, " h", halfHorz,
                        //                                            " C", midX, ",", p0[1] - offset, " ", midX, ",", p1[1] - offset, " ", p1[0] - halfHorz, ",", p1[
                        //                                                1] - offset,
                        //                                            " h", halfHorz, " v", offset
                        //                                        ].join("");
                        //
                        //                                        mirror.push([" v", offset, " h", -halfHorz,
                        //                                                " C", midX, ",", p1[1] + offset, " ", midX, ",", p0[1] + offset, " ", p0[0] + halfHorz, ",",
                        //                                                p0[1] + offset,
                        //                                                " h", -halfHorz, " v", -offset
                        //                                            ]
                        //                                            .join(""));
